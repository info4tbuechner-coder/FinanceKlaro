...
const sampleData = {
    ...
    categories: [
        { id: 'c1', name: 'Gehalt', type: CategoryType.INCOME, icon: '💰', color: '#22c55e' },
        { id: 'c2', name: 'Wohnen', type: CategoryType.EXPENSE, budget: 1000, icon: '🏠', color: '#3b82f6' },
        { id: 'c3', name: 'Lebensmittel', type: CategoryType.EXPENSE, budget: 400, icon: '🛒', color: '#f97316' },
        { id: 'c4', name: 'Investments', type: CategoryType.EXPENSE, icon: '📈', color: '#8b5cf6' },
        { id: 'c5', name: 'Freiberuflich', type: CategoryType.INCOME, icon: '💼', color: '#06b6d4' },
        { id: 'c6', name: 'Software', type: CategoryType.EXPENSE, budget: 100, icon: '💻', color: '#6366f1' },
        { id: 'c7', name: 'Kredit', type: CategoryType.EXPENSE, icon: '🏦', color: '#ef4444' },
    ],
    goals: [
